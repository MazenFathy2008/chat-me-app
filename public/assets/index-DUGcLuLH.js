 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ee{constructor(e){this.container=e}getPlatformInfoString(){return this.container.getProviders().map(r=>{if(_e(r)){const a=r.getImmediate();return`${a.library}/${a.version}`}else return null}).filter(r=>r).join(" ")}}function _e(t){const e=t.getComponent();return(e==null?void 0:e.type)==="VERSION"}const A="@firebase/app",H="0.11.3";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const d=new ie("@firebase/app"),Se="@firebase/app-compat",Be="@firebase/analytics-compat",De="@firebase/analytics",we="@firebase/app-check-compat",ve="@firebase/app-check",Ae="@firebase/auth",Ce="@firebase/auth-compat",Ie="@firebase/database",Oe="@firebase/data-connect",Te="@firebase/database-compat",Me="@firebase/functions",$e="@firebase/functions-compat",Re="@firebase/installations",He="@firebase/installations-compat",Ne="@firebase/messaging",Le="@firebase/messaging-compat",Pe="@firebase/performance",xe="@firebase/performance-compat",Ve="@firebase/remote-config",Fe="@firebase/remote-config-compat",We="@firebase/storage",je="@firebase/storage-compat",Ue="@firebase/firestore",ke="@firebase/vertexai",Ge="@firebase/firestore-compat",Ke="firebase",Je={[A]:"fire-core",[Se]:"fire-core-compat",[De]:"fire-analytics",[Be]:"fire-analytics-compat",[ve]:"fire-app-check",[we]:"fire-app-check-compat",[Ae]:"fire-auth",[Ce]:"fire-auth-compat",[Ie]:"fire-rtdb",[Oe]:"fire-data-connect",[Te]:"fire-rtdb-compat",[Me]:"fire-fn",[$e]:"fire-fn-compat",[Re]:"fire-iid",[He]:"fire-iid-compat",[Ne]:"fire-fcm",[Le]:"fire-fcm-compat",[Pe]:"fire-perf",[xe]:"fire-perf-compat",[Ve]:"fire-rc",[Fe]:"fire-rc-compat",[We]:"fire-gcs",[je]:"fire-gcs-compat",[Ue]:"fire-fst",[Ge]:"fire-fst-compat",[ke]:"fire-vertex","fire-js":"fire-js",[Ke]:"fire-js-all"};/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Xe={"no-app":"No Firebase App '{$appName}' has been created - call initializeApp() first","bad-app-name":"Illegal App name: '{$appName}'","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","server-app-deleted":"Firebase Server App has been deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}.","finalization-registry-not-supported":"FirebaseServerApp deleteOnDeref field defined but the JS runtime does not support FinalizationRegistry.","invalid-server-app-environment":"FirebaseServerApp is not for use in browser environments."},O=new j("app","Firebase",Xe);function y(t,e,r){var a;let n=(a=Je[t])!==null&&a!==void 0?a:t;r&&(n+=`-${r}`);const s=n.match(/\s|\//),o=e.match(/\s|\//);if(s||o){const c=[`Unable to register library "${n}" with version "${e}":`];s&&c.push(`library name "${n}" contains illegal characters (whitespace or "/")`),s&&o&&c.push("and"),o&&c.push(`version name "${e}" contains illegal characters (whitespace or "/")`),d.warn(c.join(" "));return}C(new D(`${n}-version`,()=>({library:n,version:e}),"VERSION"))}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ze="firebase-heartbeat-database",qe=1,p="firebase-heartbeat-store";let B=null;function G(){return B||(B=ge(Ze,qe,{upgrade:(t,e)=>{switch(e){case 0:try{t.createObjectStore(p)}catch(r){console.warn(r)}}}}).catch(t=>{throw O.create("idb-open",{originalErrorMessage:t.message})})),B}async function Qe(t){try{const r=(await G()).transaction(p),a=await r.objectStore(p).get(K(t));return await r.done,a}catch(e){if(e instanceof b)d.warn(e.message);else{const r=O.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});d.warn(r.message)}}}async function P(t,e){try{const a=(await G()).transaction(p,"readwrite");await a.objectStore(p).put(e,K(t)),await a.done}catch(r){if(r instanceof b)d.warn(r.message);else{const a=O.create("idb-set",{originalErrorMessage:r==null?void 0:r.message});d.warn(a.message)}}}function K(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ot(t){C(new D("platform-logger",e=>new Ee(e),"PRIVATE")),C(new D("heartbeat",e=>new rt(e),"PRIVATE")),y(A,H,t),y(A,H,"esm2017"),y("fire-js","")}ot("");var it="firebase",ct="11.5.0";/**
 * @license
